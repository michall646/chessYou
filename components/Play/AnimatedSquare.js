  ...
  const theme = useTheme();
    ...
    const animatedStyle = useAnimatedStyle(() => {
        ...
        const backgroundColor = interpolateColor(
            ...
            [props.backgroundColor, props.highlightColor] // Output colors
        );
    ...
    return (
        <>
        <Animated.View style={[{width: props.size, height: props.size, borderRadius: props.size/ 10}, animatedStyle]}>
...
export default memo(AnimatedSquare)